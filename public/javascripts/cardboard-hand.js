...
gridHelper1.position = new THREE.Vector3( 5, -5, 0 );

var gridHelper2 = new THREE.GridHelper( size, step );

gridHelper2.position = new THREE.Vector3( 5, -5, 0 );
...
function getDeviceRotation(evt){
  //read event data from device
    ...
    console.log(evt, accelerometer);

    $(".accelerometer").html("x:" +accelerometer.x+", y:" +accelerometer.y+", z:" +accelerometer.z);
}
